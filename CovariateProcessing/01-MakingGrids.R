# Making Grids: Predicting density and assessing factors driving marbled murrelet distribution in Puget Sound using hierarchical distance sampling
...
shoreline <- st_read("../GIS_COVS/Dclass_cut.gpkg")
ss_bath <- terra::rast("../GIS_COVS/SS_Bathymetry/SS_Bathymetry.tif")
puget_polygon <- st_read("../GIS_COVS/puget_poly.gpkg")
