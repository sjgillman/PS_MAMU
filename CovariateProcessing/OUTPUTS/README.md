- `grid2km_hex.gpkg`
Grids used throughout the analysis and where density is assigned to. Made in [**01-MakingGrids.pdf**](https://github.com/sjgillman/PS_MAMU/blob/main/CovariateProcessing/01-MakingGrids.pdf).

- `all_static_hex.csv`
CSV version of static covariates for grid cells made in [**02-StaticCovariates.pdf**](https://github.com/sjgillman/PS_MAMU/blob/main/CovariateProcessing/02-StaticCovariates.pdf) and used in [**DataAnalysis**](https://github.com/sjgillman/PS_MAMU/blob/main/DataAnalysis).
