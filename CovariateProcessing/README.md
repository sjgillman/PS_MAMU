...
[01-MakingGrids.pdf]([CovariateProcessing/01-MakingGrids.pdf](https://github.com/sjgillman/PS_MAMU/blob/10d91edde9534a9213510fe56ec3659497a6a05c/CovariateProcessing/01-MakingGrids.pdf)) This script is used to construct a clean, continuous hexagonal analytical grid over the study area in the Puget Sound region. It uses `reduced_area.gpkg`, `Dclass_cut.gpk`, and `puget_poly.gpkg` located in [GIS_COVS]([CovariateProcessing/GIS_COVS](https://github.com/sjgillman/PS_MAMU/blob/10d91edde9534a9213510fe56ec3659497a6a05c/GIS_COVS).
