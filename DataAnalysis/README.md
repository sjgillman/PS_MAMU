...
[**07-FormattingData.pdf**](https://github.com/sjgillman/PS_MAMU/blob/main/DataAnalysis/07-FormattingData.pdf) This script is used to check candidiate covariates and prepare data for inputting into the the model.
...
- Uses `CH1_nSQ_results_1.RData`, `CH1_nSQ_results_2.RData`, `CH1_nSQ_results_3.RData` from [**HDS_Model.R**](https://github.com/sjgillman/PS_MAMU/blob/main/DataAnalysis/HDS_Model.R)
